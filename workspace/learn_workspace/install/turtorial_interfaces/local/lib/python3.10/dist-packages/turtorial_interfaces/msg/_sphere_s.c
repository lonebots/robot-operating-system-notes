...
bool turtorial_interfaces__msg__sphere__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtorial_interfaces.msg._sphere.Sphere", full_classname_dest, 39) == 0);
  }
  turtorial_interfaces__msg__Sphere * ros_message = _ros_message;
  {  // center
...
PyObject * turtorial_interfaces__msg__sphere__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtorial_interfaces.msg._sphere");
