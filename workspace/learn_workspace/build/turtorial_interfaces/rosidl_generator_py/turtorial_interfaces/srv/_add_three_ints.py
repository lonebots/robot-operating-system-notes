...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'turtorial_interfaces.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from turtorial_interfaces.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from turtorial_interfaces.srv._add_three_ints import AddThreeInts_Request as Request
    from turtorial_interfaces.srv._add_three_ints import AddThreeInts_Response as Response
